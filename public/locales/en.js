export default {
  ...
  common: {
    ...
    edit: 'Edit', close: 'Close', cancel: 'Cancel', save: 'Save', productLibrary: 'Products & Knowledge'
  },
  ...
  productFoundation: {
    productsTitle: 'Product Intelligence Center', productsSubtitle: 'Product data workspace for AI Sales OS.', newProduct: 'New Product', products: 'Products', productListHelp: 'Product Library records used by sales, quotes, PI, and AI readiness.',
    categories: 'Product Categories', categoriesHelp: 'Manage product categories and their applicable specification attributes.', newCategory: 'New Product Category', categoryAttributes: 'Category Attribute Template',
    tags: 'Product Tags', tagsHelp: 'Product tags support search, marketing, and use cases. Do not use tags for formal specifications such as dimensions or materials.', newTag: 'New Product Tag',
    attributes: 'Specification Attributes', attributesHelp: 'Define reusable, category-specific formal product specifications.', newAttribute: 'New Specification Attribute', englishName: 'English Name', chineseName: 'Chinese Name', attributeCode: 'Attribute Code', codeHelp: 'Generated from the English name. Used attributes keep a stable code.', allowedValues: 'Allowed Values', minimum: 'Minimum', maximum: 'Maximum',
    variants: 'Product Variants', variantsHelp: 'A variant is the same product model with only a small number of specification differences.', newVariant: 'New Product Variant', parentProduct: 'Parent Product', variantOptions: 'Variant Options', variantName: 'Variant Name', variantImage: 'Variant Image', salesPriceOverride: 'Sales Price Override', overrideDefaults: 'Override Product Defaults', overrideHelp: 'Leave fields blank to inherit Product defaults.', commercialSupplier: 'Commercial & Supplier Information',
    variantAxes: 'Variant Axes', axisEligible: 'Can be Variant Axis', axisWarning: 'This product has many core differences. Confirm whether it should be split into separate products.', fixedAttributes: 'Product Fixed Attributes', saveAttributes: 'Save Specifications',
    required: 'Required', filterable: 'Filterable', showProduct: 'Product', showQuote: 'Quote', showPi: 'PI', internalOnly: 'Internal only', defaultUnit: 'Default Unit', sortOrder: 'Sort Order', active: 'Active', disabled: 'Disabled', dataType: 'Data Type', unit: 'Unit', options: 'Options', status: 'Status', actions: 'Actions', edit: 'Edit', remove: 'Delete', save: 'Save', create: 'Create', allCategories: 'All Categories', allVariants: 'All Product Variants', noAttributes: 'No specification attributes are configured.', noVariants: 'No product variants are configured.', inherited: 'Inherited', skuHelp: 'SKU means Stock Keeping Unit.', cbmHelp: 'CBM means cubic metres.', moqHelp: 'MOQ means minimum order quantity.',
    attributesTitle: 'Specification Attributes', attributesSubtitle: 'Category-specific formal product and variant specifications.', newAttribute: 'New Specification Attribute', createAttribute: 'Create Attribute', nameEn: 'English Name', nameZh: 'Chinese Name', generatedFromEnglish: 'Generated from English name', applicableCategories: 'Applicable Product Categories', categorySpecificHelp: 'Select at least one category; applicability is explicit rather than global.', productLibrary: 'Product Library', website: 'Website', quote: 'Quote', pi: 'PI', usedBy: 'Used by', noAttributes: 'No specification attributes are configured.', categoryChangeWarning: 'This category change may make existing specification values inapplicable. Existing values will be preserved; continue and review the new category specifications?', typeText: 'Text', typeNumber: 'Number', typeSelect: 'Select', typeMultiselect: 'Multi-select', typeBoolean: 'Boolean', typeColor: 'Color', typeDimension: 'Dimension', typeDate: 'Date', defaultSupplier: 'Default Supplier', supplierSku: 'Supplier SKU', supplierCost: 'Supplier Cost', supplierLeadTime: 'Supplier Lead Time (days)', supplierMoq: 'Supplier MOQ', supplierNotes: 'Supplier Notes', grossWeight: 'Gross Weight (kg)', netWeight: 'Net Weight (kg)', packingInformation: 'Packing Information',
    dashboardHeading: 'Product data workspace for AI Sales OS', dashboardHelp: 'Review product readiness for sales, quotes, PI, and future AI matching. Product Library remains the single source of truth.', allRecords: 'All Product Library records', activeProducts: 'Active Products', availableRecords: 'Available product records', readyQuote: 'Products Ready for Quote', quality80: 'Data quality 80+', readyAi: 'Products Ready for AI', ai80: 'AI readiness 80+', missingInformation: 'Products Missing Information', needsDataWork: 'Needs product data work', reviewStates: 'Draft / review / incomplete', qualitySummary: 'Data Quality Summary', qualityHelp: 'Missing fields that block quote and AI readiness.', missingAttributes: 'Missing attributes', missingVariants: 'Missing variants', missingPricing: 'Missing pricing information', statusSummary: 'Product Status Summary', statusHelp: 'Current Product Library workflow states.', sourceTruth: 'Product Library / Product Intelligence Center', searchProduct: 'Search product name or SKU', allDataQuality: 'All Data Quality', needsImprovement: 'Needs Improvement', allPricing: 'All Pricing', pricingReady: 'Pricing Ready', needsPricing: 'Needs Pricing', productImage: 'Product Image', skuCode: 'SKU / Product Code', variantCount: 'Variant Count', qualityScore: 'Data Quality Score', aiStatus: 'AI Readiness Status'
  },
  fields: {
    name: 'Name', code: 'Code', group: 'Group', description: 'Description', opportunity: 'Opportunity', stage: 'Stage', value: 'Value', owner: 'Owner', nextAction: 'Next action', product: 'Product',
    ...
    role: 'Role', lastActive: 'Last active', module: 'Module', projectPrompt: 'Project prompt', spaceType: 'Space type', dataType: 'Data Type', options: 'Options (one per line)', unit: 'Unit', sortOrder: 'Sort Order', display: 'Display',
  ...
  salesOs: {
    groups: { workspace: 'Workspace', opportunities: 'Opportunities & Customers', products: 'Products & Knowledge', commercial: 'Solutions & Commercial', system: 'System' },
    tabs: { dashboard: 'Opportunity Dashboard', discovery: 'AI Discovery', strategies: 'Search Strategies', tasks: 'Search Tasks', leads: 'Lead Pool', customers: 'Customers', priority: 'Priority View' },
    terms: {
      searchStrategy: 'Search Strategy', searchTask: 'Search Task', searchExecution: 'Search Execution', searchResult: 'Search Result', leadDetail: 'Lead Detail', customer: 'Customer', aiQualification: 'AI Qualification', rulesAssessment: 'Rules Assessment', purchasePotential: 'Purchase Potential', productMatching: 'Product Matching', sourceEvidence: 'Source & Evidence', connector: 'Connector', connectorVersion: 'Connector Version', externalId: 'External ID', sourceUrl: 'Source URL', capturedTime: 'Captured Time', duplicateStatus: 'Duplicate Status', normalizationVersion: 'Normalization Version', planningEstimate: 'Planning Estimate', estimatedCost: 'Estimated Cost', approvedLimit: 'Approved Limit', searchCriteria: 'Search Criteria', customerType: 'Customer Type', location: 'Location', companySize: 'Company Size', priority: 'Priority', targetVolume: 'Target Volume', keywords: 'Keywords', requiredDataFields: 'Required Data Fields', filters: 'Filters', searchResults: 'Search Results', totalResults: 'Total Results', converted: 'Converted', storedCandidates: 'Stored candidates', movedCustomers: 'Moved to Customers CRM', openLeads: 'Open leads', score: 'Score', websiteContact: 'Website & Contact', website: 'Website', contact: 'Contact', aiSummary: 'AI Summary', aiRecommendation: 'AI Recommendation', qualificationReason: 'Qualification Reason', referenceNote: 'Reference Note', activityHistory: 'Activity History', phase: 'Phase', pages: 'Pages', received: 'Received', normalized: 'Normalized', inserted: 'Inserted', duplicates: 'Duplicates', lastHeartbeat: 'Last heartbeat', stopReason: 'Stop reason', unknown: 'Unknown', source: 'Source', countryCity: 'Country / City', businessType: 'Business Type', customerValue: 'Customer Value', buyingOpportunity: 'Buying Opportunity', salesPriority: 'Sales Priority', grade: 'Grade', recommendedProducts: 'Recommended Products', nextAction: 'Next Action', assignedSales: 'Assigned Sales', duplicateCheck: 'Duplicate Check', openDataGaps: 'Open Data Gaps', lastAiRun: 'Last AI Run'
    },
    actions: { saveDraft: 'Save Draft', createDraft: 'Create Draft', submitReview: 'Submit Review', approve: 'Approve', requestChanges: 'Request Changes', archive: 'Archive', markOutdated: 'Mark Outdated', aiGenerate: 'AI Generate', planningEstimate: 'Planning Estimate', markReady: 'Mark Ready', estimateExecution: 'Estimate Execution', createExecution: 'Create Execution', start: 'Start', pause: 'Pause', resume: 'Resume', stop: 'Stop', runAi: 'Run AI', updateIntelligence: 'Update Intelligence', markReviewed: 'Mark Reviewed', convertCustomer: 'Convert to Customer', discard: 'Discard', open: 'Open', edit: 'Edit', back: 'Back', viewSource: 'View Source', importCustomers: 'Import Customers' },
    status: { draft: 'Draft', needsReview: 'Needs Review', approved: 'Approved', superseded: 'Superseded', archived: 'Archived', new: 'New', reviewed: 'Reviewed', running: 'Running', paused: 'Paused', completed: 'Completed', partiallyCompleted: 'Partially Completed', failed: 'Failed', interrupted: 'Interrupted', blocked: 'Blocked', aiQualified: 'AI Qualified', aiPending: 'AI Qualification Pending', aiRunning: 'AI Qualification Running', aiFailed: 'AI Qualification Failed', aiBlocked: 'AI Qualification Blocked', complete: 'Complete', discarded: 'Discarded', awaitingApproval: 'Awaiting Approval', rulesReady: 'Rules ready', productConnected: 'Product intelligence connected' },
    history: { leadCreated: 'Lead created', aiStarted: 'AI qualification started', aiCompleted: 'AI qualification completed', aiFailed: 'AI qualification failed', reviewedBy: 'Marked as reviewed by {{name}}', converted: 'Converted to customer', legacy: 'Legacy record' },
    messages: { opportunitySubtitle: 'Turn sourced customer data into clean, scored, product-matched, human-approved sales opportunities.', leadPoolSubtitle: 'Review qualified leads before converting them into CRM customers.', noResults: 'No search results yet.', noLeads: 'No leads are available.', noCustomers: 'No customers yet.', aiPendingSummary: 'AI qualification summary is pending.', noDuplicate: 'No duplicate detected', noError: 'No error', notProvided: 'Not provided', notRun: 'Not run', priorityQueue: 'Today’s Priority Queue', priorityQueueSubtitle: 'Highest-value A+/A opportunities ready for human action', pipelineStatus: 'AI Pipeline Status', pipelineStatusSubtitle: 'Rule provider is active; external AI remains optional.', live: 'Live', opportunityMetrics: 'Opportunity Intelligence Metrics', opportunityMetricsSubtitle: 'Today’s customer intelligence and sales handoff readiness', openEngine: 'Open Engine', confirmFreight: 'Confirm freight estimate', reviewSamples: 'Review finish samples', scheduleCall: 'Schedule design call', sendEmail: 'Send discovery email', productionHandoff: 'Prepare production handoff' },
    metrics: { totalCustomers: 'Total Customers', importedToday: 'Imported Today', aiProcessed: 'AI Processed', gradeAPlus: 'A+ Opportunities', gradeA: 'A Opportunities', readyForSales: 'Ready for Sales', missingDecisionMaker: 'Missing Decision Maker', missingEmail: 'Missing Email', missingWhatsApp: 'Missing WhatsApp', acceptedLeads: 'Sales Accepted Leads' },
    searchUi: { backTasks: 'Back to Search Tasks', controlledExecution: 'Controlled Rules/Mock execution. No external platform is called.', providerComplete: 'Provider Complete', checkpointError: 'Checkpoint and last error', resultsSubtitle: 'Store manually discovered leads before they enter the Lead Pool', addResult: 'Add Search Result', entryHelp: '30-second entry. AI Qualification runs after saving; no external search API is connected.', companyName: 'Company Name', country: 'Country', city: 'City', sourceType: 'Source Type', contactOptional: 'Contact Information (Optional)', customerEvidence: 'Customer Evidence', evidencePlaceholder: 'Google Maps, Instagram, Website, or LinkedIn URL', notePlaceholder: 'Short note for future handoff', attachmentHelp: 'Screenshot / Attachment: future. Save the source link or note here for now.', saveResult: 'Save Search Result', company: 'Company', potential: 'Potential', status: 'Status', actions: 'Actions', restaurantDealers: 'Restaurant Furniture Dealers', unitedStates: 'United States', medium: 'Medium', high: 'High', low: 'Low', decisionMaker: 'Decision Maker', manual: 'Manual', other: 'Other', noContact: 'No contact information yet', missing: 'Missing', reviewLead: 'Review lead' },
    leadUi: { backPool: 'Back to Lead Pool', formalAi: 'Formal AI Qualification', initialRules: 'Initial Rules / Manual Data', customerIntelligence: 'Customer Intelligence', customerIntelligenceHelp: 'This lead is still before CRM conversion. Use AI qualification, evidence, and product matching to decide whether it should become a Customer.', historyHelp: 'Lead workflow history before CRM conversion', capturedMock: 'Captured by approved Rules/Mock Connector.', immediateReview: 'Review immediately, verify decision maker, and prepare a first sales touch.', productDirection: 'Run qualification to prepare product direction.', noReason: 'No qualification reason yet.', convertDecision: 'Review the lead and decide whether to convert.', mockAiSummary: 'Northwest Table Base Co is a Restaurant Furniture Dealers candidate in Seattle, United States with High purchase potential.', mockProductMatch: 'Hospitality furniture reseller: recommend Booth Seating, Restaurant Tables, and Dining Chairs as repeatable catalog products.', mockQualification: 'Restaurant Furniture Dealers matches the active search task. Purchase potential: High. Contact or website information is available. Source evidence is saved for future handoff. Evidence note: Captured by approved Rules/Mock Connector..' },
    legacyUi: {
      addProduct: 'Add Product', editProduct: 'Edit Product', deleteProduct: 'Delete Product', createProduct: 'Create Product', addCategory: 'Add Category', newCategory: 'New Category', createCategory: 'Create Category', addTag: 'Add Tag', newTag: 'New Tag', createTag: 'Create Tag', addAttribute: 'Add Attribute', newAttribute: 'New Attribute', createAttribute: 'Create Attribute', newVariant: 'New Variant', createVariant: 'Create Variant', addVariant: 'Add Variant', delete: 'Delete', enable: 'Enable', disable: 'Disable', history: 'History', newRevision: 'New Revision', cancelEdit: 'Cancel Edit', backProducts: 'Back to Products', openCustomer: 'Open Customer', analyzeRequirement: 'Analyze Requirement', generateSearchPlan: 'Generate Search Plan', createStrategy: 'Create Strategy Draft', createTask: 'Create Draft Search Task', archiveStrategy: 'Archive Strategy', contextPreview: 'Context Preview', analyzeCustomers: 'Analyze Selected Customers', saveRunIntelligence: 'Save & Run Customer Intelligence', saveFeedback: 'Save Feedback', acceptLead: 'Accept Lead', generatePackage: 'Generate Furniture Package', generateQuote: 'Generate Quote', generatePi: 'Generate PI', convertOrder: 'Convert to Order', markSent: 'Mark Sent Manually', previewPi: 'Preview PI', exportPdf: 'Export PDF', exportExcel: 'Export Excel', addLibraryProduct: 'Add Product from Library', addCustomItem: 'Add Custom Item', next: 'Next', previous: 'Previous',
      name: 'Name', group: 'Group', dataType: 'Data Type', options: 'Options (one per line)', unit: 'Unit', sortOrder: 'Sort Order', display: 'Display', dimensions: 'Dimensions', referencePrice: 'Reference Price', costPrice: 'Cost Price', allCategories: 'All Categories', allVariants: 'All Variants', description: 'Descriptions', shortDescription: 'Short Description', updated: 'Updated', lastUpdated: 'Last Updated', pricing: 'Pricing', pricingSummary: 'Pricing Summary', pricingStatus: 'Pricing Status', sellingCurrency: 'Selling Currency', supplierCost: 'Supplier Cost', supplierCurrency: 'Supplier Currency', convertedCost: 'Converted Cost', recommendedSelling: 'Recommended Selling Price', ruleName: 'Rule Name', calculationMethod: 'Calculation Method', multiplierMargin: 'Multiplier / Margin', rounding: 'Rounding', productFoundation: 'Product Foundation', configurableAttributes: 'Configurable Attributes', relatedProducts: 'Related Products', frequentlyBought: 'Frequently Bought Together', productImages: 'Product Images', uploadImage: 'Upload Image', markMain: 'Mark Main', basicInfo: 'Basic Info', industry: 'Industry', purchaseTiming: 'Purchase Timing', confidence: 'Confidence', originalSource: 'Original Source', evidence: 'Evidence', customerSource: 'Customer Source', opportunityStatus: 'Opportunity Status', recommendedAction: 'Recommended Action', feedback: 'Feedback', amount: 'Amount', quantity: 'Quantity', unitPrice: 'Unit Price', lineTotal: 'Line Total', total: 'Total', currency: 'Currency', issueDate: 'Issue Date', validUntil: 'Valid Until', paymentTerms: 'Payment Terms', freight: 'Freight', destination: 'Destination', remarks: 'Remarks', attachments: 'Attachments',
      productCenter: 'Product Intelligence Center', productDetails: 'Product Details', productStatus: 'Product Status', productCompleteness: 'Product Completeness', pricingReady: 'Pricing Ready', needsImprovement: 'Needs Improvement', productReviewHelp: 'Review product readiness for sales, quotes, PI, and future AI matching. Product Library remains the single source of truth.', variantsHelp: 'Variants, configurable attributes, related products, and frequently bought together.', noProducts: 'No products yet.', noVariants: 'No variants yet.', noAttributes: 'No attributes.', noImages: 'No images uploaded.', noContacts: 'No contacts.', noFeedback: 'No feedback yet.', noEvidence: 'No evidence updates recorded yet.', noImports: 'No import batches yet.', noDrafts: 'No drafts detected.', noMatches: 'No matching products found.', noKnowledge: 'No knowledge records yet.', noTasks: 'No search tasks yet. Generate a Search Plan, then click Create Search Task.', requestQuote: 'Request Quote', comingSoon: 'Coming Soon', discontinued: 'Discontinued', hidden: 'Hidden', urgent: 'Urgent', normal: 'Normal', allStatuses: 'All Statuses', allSources: 'All Sources', allGrades: 'All Grades', allCustomerTypes: 'All Customer Types',
      importReview: 'Product Import Review', uploadSettings: 'Upload & Import Settings', analyzeSpreadsheet: 'Analyze Spreadsheet', smartResult: 'Smart Analysis Result', detectedProducts: 'Detected Products', detectedVariants: 'Detected Variants', mappedColumns: 'Mapped Columns', embeddedImages: 'Embedded Images', draftReview: 'Draft Review', editMappings: 'Edit mappings before importing into the Product Library.', importResult: 'Import Result', createdProducts: 'Created Products', createdVariants: 'Created Variants', skippedRows: 'Skipped Rows', errors: 'Errors', importBatches: 'Import Batches', approveImport: 'Approve & Import', approveSelected: 'Approve Selected', mergeSelected: 'Merge Selected', splitProducts: 'Split into Products', reject: 'Reject', saveAttributes: 'Save Attributes',
      noImage: 'No image', imageNeeded: 'Image Assets Needed', supplierHidden: 'Supplier hidden by role', supplierNotSet: 'Supplier not set', imagePending: 'Supplier image evidence pending', smartDetect: 'Smart detect', createNewProduct: 'Create new product', updateExisting: 'Update existing product', addNewVariant: 'Add as new variant', ignore: 'Ignore', requiredRecognized: 'Required fields recognized'
    },
    units: { companies: '{{count}} companies' }
  },
  access: {
